...
public class UserTestControllerUsingRestTemplate {
    ...
    public User getUserById(@PathVariable("id") int id) {
        ...
        URI uri = UriComponentsBuilder
                .fromUriString("http://localhost:8083/user/{id}")
    ...
    public ResponseEntity addUser(@RequestBody User user) {
        ...
        ResponseEntity exchange = restTemplate
                .exchange("http://localhost:8083/user/", HttpMethod.POST, request, String.class);
    ...
    public ResponseEntity deleteUser(@PathVariable int id) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.delete("http://localhost:8083/user/{id}", params);
